        ...
        { // Main Window Area
            ...
            GUILayout.BeginVertical();
            {
                ...
                GUILayout.BeginHorizontal();
                {
                    ...
                    var interact = GameManager.Instance.interactiveMode;
                    interact = (bool)GUILayout.Toggle(interact, "");
                    if (GUI.changed)
                ...
                GUILayout.BeginHorizontal();
                {
                    GUILayout.Label("Muted: ", GUILayout.Width(WINDOW_DIMENSION.x / 4.0f));
                    var muted = SoundManager.Instance.masterMuted;
                    muted = (bool)GUILayout.Toggle(muted, "");
                    if (GUI.changed)
                ...
                GUILayout.BeginHorizontal();
                {
                    ...
                    volume = (float)GUILayout.HorizontalSlider(volume, -80.0f, 20.0f, GUILayout.ExpandWidth(true));
                    if (GUI.changed)
